#ifndef _CHEST_INV_RENDERER
#define _CHEST_INV_RENDERER
...
class ChestInvRenderer {
public:
    ChestInvRenderer(sf::Font& _f, sf::Texture& _t, Player& _p) :
    ...
    void set_chest(ChestEntity* current_chest);
